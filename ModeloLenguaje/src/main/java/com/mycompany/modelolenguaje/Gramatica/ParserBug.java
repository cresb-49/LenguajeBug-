...
public class ParserBug extends java_cup.runtime.lr_parser {
     ...
     */
    @Deprecated
    public ParserBug(java_cup.runtime.Scanner s) {
        super(s);
    }
     ...
     * Constructor which sets the default scanner.
     */
    public ParserBug(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {
        super(s, sf);
    }
    ...
    private Instruccion inicializarFuncion(Integer tipo, Token id, List<Declaracion> params, Sentencias sen, int linea, int columna) {
        return new Funcion(tipo, id.lexema, sen, params, linea, columna);
    }
    ...
    class CUP$ParserBug$actions {
        ...
        public final java_cup.runtime.Symbol CUP$ParserBug$do_action_part00000000(
            ...
            switch (CUP$ParserBug$act_num) {
                ...
                {
                    Object RESULT = null;
                    int intruccionesleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.peek()).left;
                    int intruccionesright = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.peek()).right;
                    Object intrucciones = (Object) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.peek()).value;
                ...
                {
                    Object RESULT = null;
                    int globalesleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.peek()).left;
                    int globalesright = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.peek()).right;
                    Instruccion globales = (Instruccion) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.peek()).value;
                    System.out.println(globales.toString());
                ...
                {
                    Instruccion RESULT = null;
                    int tipoleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 5)).left;
                    int tiporight = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 5)).right;
                    Integer tipo = (Integer) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 5)).value;
                    int idleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 4)).left;
                    int idright = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 4)).right;
                    Token id = (Token) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 4)).value;
                    RESULT = inicializarFuncion(tipo, id, null, null, id.linea, id.columna);
                ...
                {
                    Instruccion RESULT = null;
                    int tipoleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 6)).left;
                    int tiporight = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 6)).right;
                    Integer tipo = (Integer) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 6)).value;
                    int idleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 5)).left;
                    int idright = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 5)).right;
                    Token id = (Token) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 5)).value;
                    int senleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 1)).left;
                    int senright = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 1)).right;
                    Sentencias sen = (Sentencias) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 1)).value;
                    RESULT = inicializarFuncion(tipo, id, null, sen, id.linea, id.columna);
                ...
                case 14: // funcion ::= tipoDato ID PAR_A parametros PAR_C LL_A LL_C 
                {
                    ...
                    int idright = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 5)).right;
                    Token id = (Token) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 5)).value;
                    int paramsleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 3)).left;
                    int paramsright = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 3)).right;
                    List<Declaracion> params = (List<Declaracion>) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 3)).value;
                    RESULT = inicializarFuncion(tipo, id, params, null, id.linea, id.columna);
                    CUP$ParserBug$result = parser.getSymbolFactory().newSymbol("funcion", 17, ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 6)), ((java_cup.runtime.Symbol) CUP$ParserBug$stack.peek()), RESULT);
                }
                return CUP$ParserBug$result;
                ...
                {
                    Instruccion RESULT = null;
                    int tipoleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 7)).left;
                    int tiporight = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 7)).right;
                    Integer tipo = (Integer) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 7)).value;
                    int idleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 6)).left;
                    int idright = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 6)).right;
                    Token id = (Token) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 6)).value;
                    int paramsleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 4)).left;
                    int paramsright = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 4)).right;
                    List<Declaracion> params = (List<Declaracion>) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 4)).value;
                    int senleft = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 1)).left;
                    int senright = ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 1)).right;
                    Sentencias sen = (Sentencias) ((java_cup.runtime.Symbol) CUP$ParserBug$stack.elementAt(CUP$ParserBug$top - 1)).value;
                    RESULT = inicializarFuncion(tipo, id, params, sen, id.linea, id.columna);
