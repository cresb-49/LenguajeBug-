 ...
 public final Class getSymbolContainer() {
  ...
  public int error_sym() {return 1;}
    ...
    private Instruccion inicializarFuncion(Integer tipo, Token id, List<Declaracion> params, Sentencias sen,int linea,int columna) {
        Funcion funcion = new Funcion(tipo,id.lexema, sen, params,linea,columna);
        if(funcion.getId().equals("main")){
            System.out.println("Funcion main encontrada");
        }
        return funcion;
    }
